...
struct RenderParams {
    ...
    viewport_x: i32,
    viewport_y: i32,
    viewport_width: u32,   // Add this
    viewport_height: u32,  // Add this
    view_radius: f32,
    dither_radius: f32,
...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    if (dist <= params.view_radius) {
        ...
        let factor = (dist - (params.view_radius + params.dither_radius)) / 
                     (params.super_far_radius - params.view_radius - params.dither_radius);
